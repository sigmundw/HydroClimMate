...
This project follows the HydroClimMate workflow. Integration: <native hydroclimmate skill OR explicit path to hydroclimmate/SKILL.md; choose one>

That file and the references beside it carry the general rules — evidence and reporting standards, escalation, data semantics, grid and area weighting, validation. Do not copy them here. This file records only what is specific to this project.
...
Keep this file around 20 lines. If a rule here would apply to any project in the lab, it belongs in the workflow files instead.
