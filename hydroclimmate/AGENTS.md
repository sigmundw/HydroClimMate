...
Explicit project-workflow entry point for tools that read AGENTS.md. Claude Code and
Codex can also load SKILL.md natively; use one primary entry path, not both.
